...
@Entity
@Table(name = "BGLS_USER_PROFILE_TABLE")
public class UserProfile implements UserDetails {
	...
	private String doc_access_code;
	private String branch_id;
	private String branch_des;
	...
	public String getDoc_access_code() {
		return doc_access_code;
	}

	public void setDoc_access_code(String doc_access_code) {
		this.doc_access_code = doc_access_code;
	}
	...
	public String getBranch_des() {
		return branch_des;
	}

	public void setBranch_des(String branch_des) {
		this.branch_des = branch_des;
	}
...
//	@Override
	 ...
	 * 
	 * if(currTime.isAfter(low) && currTime.isBefore(high)) { return true; }else {
	 * 
	 * return false; }
	 * 
	 * 
	...
	public UserProfile(String empid, String emp_name, String userid, String username, String inactive_time,
			Date acc_exp_date, String login_low, String login_high, Date disable_start_date, Date disable_end_date,
			String password, Date pass_exp_date, String user_status, String login_status, String virtual_flg,
			String work_class, String mob_number, String email_id, String role_id, String role_desc, String permissions,
			String per_effctive_date, String admin, String archivel, String general_inq, String audit_inq,
			...
			String login_flg, String user_locked_flg, Integer no_of_attmp, String disable_flg, Blob photo,
			String domain_id, String acct_access_code, String doc_access_code, String branch_id, String branch_des,
			String remarks) {
		super();
		this.empid = empid;
		this.emp_name = emp_name;
	...
	public UserProfile(UserProfile userProfile) {
		...
		this.disable_start_date = userProfile.disable_start_date;
		this.disable_end_date = userProfile.disable_end_date;
		...
		this.acct_access_code = userProfile.getAcct_access_code();
		this.doc_access_code = userProfile.getDoc_access_code();
		this.branch_id = userProfile.getBranch_id();
		this.branch_des = userProfile.getBranch_des();
